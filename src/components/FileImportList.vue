...
<script setup lang="ts">import { humanFileSize } from "@silveredgold/beta-shared";
import { NButton, NCard, NThing, NTooltip, NTree, TreeOption } from 'naive-ui';
import { Ref, computed, ref, toRefs } from 'vue';
import { DirectoryFileList, FileSystemClient, toFileList } from '../services';
